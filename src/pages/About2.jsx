...
function About() {
  ...
  const openFrontendRepo = () => {
    window.open("https://github.com/giadaunger/MixSkincareFrontend", "_blank");
  };

  const openBackendRepo = () => {
    window.open("https://github.com/giadaunger/MixSkincareBackend", "_blank");
  };
  ...
  return (
    <div className="w-11/12 mx-auto mt-12 mb-20">
      <div className="w-3/4 mx-auto justify-center">
        ...
        <div className="space-y-7 w-full text-xl mb-24">
          <div>
            ...
            <ul>
              ...
              <li><strong>Zustand</strong> – Selected for lightweight and efficient state management, making it easier to handle user interactions, product comparisons, and saved routines.</li>
            </ul>
          </div>
          <div>
            <p className="text-2xl mb-2"><strong>Backend Technologies:</strong></p>
            <ul>
              <li><strong>FastAPI (Python)</strong> – Provides efficient request handling with asynchronous capabilities, ensuring smooth API performance.</li>
              <li><strong>PostgreSQL</strong> – A reliable database system used to store and manage product and ingredient data, designed to scale as the dataset grows.</li>
            </ul>
          </div>
          <div>
            ...
            <li>- A compatibility check is performed by cross-referencing ingredients against a table of known <strong>incompatible ingredient pairs</strong> stored in the database.</li>
        ...
        <div className="flex flex-col space-y-5 sm:space-y-0 sm:space-x-10 sm:flex-row w-full justify-center">
          <button onClick={openFrontendRepo} className="flex mx-auto sm:mx-0 w-40 text-lg items-center bg-[#FFDFE9] p-2 rounded-md border border-[#FFDFE9] font-semibold shadow-xl transition duration-300 hover:scale-105 hover:bg-[white] hover:border-[#E2A3B7] hover:text-[#E2A3B7]">
            <Github className="w-10 h-10" />
            Frontend repo
          </button>
          <button onClick={openBackendRepo} className="flex mx-auto sm:mx-0 w-40 text-lg items-center bg-[#FFDFE9] p-2 rounded-md border border-[#FFDFE9] font-semibold shadow-xl transition duration-300 hover:scale-105 hover:bg-[white] hover:border-[#E2A3B7] hover:text-[#E2A3B7]">
            <Github className="w-10 h-10" />
            Backend repo
          </button>
        </div>
