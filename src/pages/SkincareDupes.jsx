      ...
      <div className="z-0">
        <div className="w-5/6 mx-auto">
          <div className="w-full md:w-2/3 mx-auto text-center mt-12">
              <h2 className="text-4xl min-[500px]:text-5xl md:text-6xl mb-4 min-[500px]:mb-10">Find Your Perfect Match! Skin</h2>
          ...
          <div className="flex justify-center items-center">
            <div className="bg-[#FFDFE9] rounded-xl w-full md:w-2/3 min-h-52 flex items-center justify-center shadow-xl">
              {chosenProduct ? (
          ...
          <div className="flex justify-center">
            ...
            className={`w-full sm:w-1/3 lg:w-1/6 mt-14 mb-28 rounded-xl shadow-lg text-center text-xl p-2 border text-black
              ${(!chosenProduct || errorMsg) ? 'bg-gray-300 border-gray-300 cursor-not-allowed opacity-50' : 'border-[#FFDFE9] bg-[#FFDFE9] hover:bg-white active:bg-[#E2A3B7] hover:text-[#E2A3B7] hover:border-[#E2A3B7] transform transition duration-300 hover:scale-110'}`}>
                Find dupes!
            </button>
          </div>
          {isLoading &&
