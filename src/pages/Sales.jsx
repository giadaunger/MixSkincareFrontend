          ...
          <div className="border-2 border-[#e2a3b7] p-4 items-center rounded-md shadow-md flex flex-row justify-between">
            <div className="items-center flex flex-row">
              <img 
                ...
                alt="kicks logo" 
                className="rounded-md h-24 w-24 mr-4"
              />
              <p className="text-2xl text-[#e2a3b7]">20% on eye & brow makeup</p>
            </div>
          ...
          <div className="border-2 border-[#e2a3b7] p-4 items-center rounded-md shadow-md flex flex-row justify-between">
            <div className="items-center flex flex-row">
              <img 
                ...
                className="rounded-md h-24 w-24 mr-4"
              />
              <p className="text-2xl text-[#e2a3b7]">25% on lip makeup</p>
            </div>
            <div className="flex justify-end p-2">
              <ArrowRight className="w-14 h-14 text-[#e2a3b7]"/>
            </div>
          ...
          <div className="border-2 border-[#e2a3b7] p-4 items-center rounded-md shadow-md flex flex-row justify-between">
            <div className="items-center flex flex-row">
              <img 
                ...
                className="rounded-md h-24 w-24 mr-4"
              />
              <p className="text-2xl text-[#e2a3b7]">Up to 50% off sitewide</p>
            </div>
            <div className="flex justify-end p-2">
              <ArrowRight className="w-14 h-14 text-[#e2a3b7]"/>
            </div>
